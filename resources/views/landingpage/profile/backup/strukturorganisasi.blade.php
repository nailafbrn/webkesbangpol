...
@section('content')
<section class="strukturorg-hero">
    <div class="strukturorg-overlay"></div>
    <div class="strukturorg-hero-content">
        <h1 class="strukturorg-title" data-aos="fade-down">Struktur Organisasi</h1>
        <p class="strukturorg-subtitle" data-aos="fade-up">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
    </div>
</section>
...
<section class="strukturorg-section">
    <div class="strukturorg-container" data-aos="fade-up">
        <div class="org-chart-container">
            <!-- SVG untuk garis -->
            <svg id="connector-svg" width="1150" height="700" style="background-color: #ffff"></svg>
...
<script>
    ...
    function generatePolylinePath(fromId, toId) {
        ...
        polyline.setAttribute("stroke", "#C7141A");
    ...
    function generateLineFromKelompokFungsionalToBidangs() {
        ...
        const horizontalLeftX = startX - 120;
    ...
    function generateLineFromKelompokFungsionalToSekretaris() {
        ...
        const horizontalFarRightX = startX + 970;
        const upY = verticalY - 383;
        const leftToEndX = horizontalFarRightX - 155;
