...
@section('content')
    <section class="lakip-hero">
        <div class="lakip-overlay"></div>
        <div class="lakip-content">
            <div class="hero-badge">
                <span class="badge-text">AKIP Report</span>
            </div>
            <h1 class="lakip-title">LAPORAN AKUNTANBILITAS KINERJA INSTANSI PEMERINTAHAN</h1>
            <p class="lakip-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="lakip-lead">Dokumen Pertanggungjawaban Kinerja Yang Menyajikan Informasi Pencapaian Sasaran Strategis Dan Hasil Pelaksanaan Program, Sebagai Wujud Transparansi Dan Akuntabilitas Instansi Pemerintah Kepada Publik</p>
        </div>
    </section>
                                    ...
                                    <td class="table-cell-actions">
                                        <div class="action-buttons">
                                            <button type="button" class="btn btn-preview preview-btn" 
                                                    ...
                                                    data-file="{{ basename($lakip->file_upload) }}" 
                                                    data-download-url="{{ asset($lakip->file_upload_wm) }}"
                                                    data-title="{{ $lakip->title }}">
