...
@section('content')
    <section class="renstra-hero">
        <div class="renstra-overlay"></div>
        <div class="renstra-content">
            <div class="hero-badge">
                <span class="badge-text">STRATEGY</span>
            </div>
            <h1 class="renstra-title">RENCANA STRATEGIS</h1>
            <p class="renstra-subtitle">Badan Kesatuan Bangsa dan Politik Kota Bandung</p>
            <p class="renstra-lead">Dokumen perencanaan jangka menengah yang memuat visi, misi, tujuan, sasaran, strategi, dan arah kebijakan untuk mencapai target pembangunan selama periode lima tahun</p>
        </div>
    </section>
            ...
            <div class="filter-section">
                <div class="filter-header">
                    <div class="filter-title-wrapper">
                        ...
                        <p class="filter-subtitle">Temukan dokumen Rencana Strategis dengan mudah</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="page-share p-3 rounded shadow-sm" style="background: #ffffff;">
                ...
                <div class="share-options d-flex gap-3">
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode('Rencana Strategi Badan Kesatuan Bangsa dan Politik Kota Bandung') }}" 
                        target="_blank" class="share-icon twitter" title="Bagikan ke Twitter">
                        <i class="fab fa-x-twitter"></i>
                    </a>
                    <a href="https://api.whatsapp.com/send?text={{ urlencode('Rencana Strategi Badan Kesatuan Bangsa dan Politik Kota Bandung') }}%20{{ urlencode(request()->fullUrl()) }}" 
                        target="_blank" class="share-icon whatsapp" title="Bagikan ke WhatsApp">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                    <a href="mailto:?subject={{ urlencode('Rencana Strategi Badan Kesatuan Bangsa dan Politik Kota Bandung') }}&body={{ urlencode('Saya ingin berbagi halaman menarik ini: ' . request()->fullUrl()) }}" 
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const loadPdfFromBase64 = async (filename) => {
                try {
                    ...
                    const response = await fetch(`/serve-document-renstra/${encodeURIComponent(filename)}`);
                    if (!response.ok) {
            ...
            const loadPdf = async (filename) => {
                ...
                try {
                    ...
                    try {
                        ...
                        const alternativeUrl = `/secure-file-renstra/${encodeURIComponent(filename)}`;
                        ...
                        try {
                            ...
                            pdfContainer.innerHTML = `
                                <object 
                                    data="/secure-file-renstra/${encodeURIComponent(filename)}" 
                                    ...
                                    <div class="text-center p-5">
                                        ...
                                        <a href="/secure-file-renstra/${encodeURIComponent(filename)}" class="btn btn-primary" target="_blank">
                            ...
                            pdfContainer.innerHTML = `
                                <div class="text-center p-5">
                                    <div class="alert alert-warning">
                                        ...
                                        <a href="/file-content-renstra/${encodeURIComponent(filename)}" class="btn btn-primary" download="${filename}">
            ...
            previewButtons.forEach(button => {
                button.addEventListener('click', async function () {
                    ...
                    if (downloadUrl) {
                        ...
                        downloadBtn.setAttribute('href', `/file-content-renstra/${encodeURIComponent(filename)}`);
                    ...
                    try {
                        ...
                        const debugResponse = await fetch(`/debug-file-renstra/${encodeURIComponent(filename)}`);
            ...
            const tableBody = document.getElementById('renstraTableBody');

            // Simpan semua baris asli sekali saja
            const allRows = Array.from(tableBody.querySelectorAll('tr.renstra-item'));
