...
<div class="container text-center mt-5">
    ...
    <div style="position: relative; width: 1000px; height: 900px; margin: auto; ">
        ...
        <!-- Elemen box -->
        @php
        function getByNip($strukturors, $nip) {
            $data = $strukturors->firstWhere('nip', $nip);
    ...
    @endphp
        ...
        <div id="kepala-badan" class="box" style="top: 0px; left: 300px;">
            @php $kepala = getByNip($strukturors, '196710051989031008'); @endphp
        ...
        <div id="sekretaris-badan" class="box" style="top: 150px; left: 700px;">
            @php $sekretaris = getByNip($strukturors, '196806011997031003'); @endphp
        ...
        <div id="subbag-umum" class="box" style="top: 310px; left: 570px;">
            @php $subbag = getByNip($strukturors, '197708242009012006'); @endphp
        ...
        <div id="bidang-1" class="box bidang" style="top: 500px; left: 5px;">
            @php $b1 = getByNip($strukturors, '197208161998031004'); @endphp
        ...
        <div id="bidang-2" class="box bidang" style="top: 500px; left: 260px;">
            @php $b2 = getByNip($strukturors, '197106071996122001'); @endphp
        ...
        <div id="bidang-3" class="box bidang" style="top: 500px; left: 485px;">
            @php $b3 = getByNip($strukturors, '197503021993111001'); @endphp
        ...
        <div id="bidang-4" class="box bidang" style="top: 500px; left: 740px;">
            @php $b4 = getByNip($strukturors, '197001141989101001'); @endphp
...
@section('js')
    ...
    document.getElementById('save-as-image').addEventListener('click', function () {
        const container = document.querySelector('.container'); // Pastikan ini elemen utama yang memuat semua box & garis
