...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Paslon Walikota: {{ $paslon->capres_nama }}</h3>
        </div>
        <div class="card-body">
            {{-- PERBAIKAN: Form action sekarang mengarah ke route 'walikota.update' yang benar --}}
            <form action="{{ route('admin.pemilu.walikota.update', $paslon->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    {{-- Kolom Calon Walikota --}}
                    <div class="col-md-6">
                        <h4>Data Calon Walikota</h4>
                        <div class="mb-3">
                    ...
                    {{-- Kolom Calon Wakil Walikota --}}
                    <div class="col-md-6">
                        <h4>Data Calon Wakil Walikota</h4>
                        <div class="mb-3">
                ...
                <div class="mt-3 d-flex justify-content-end">
                    {{-- PERBAIKAN: Tombol batal sekarang mengarah ke route 'walikota.index' yang benar --}}
                    <a href="{{ route('admin.pemilu.walikota.index') }}" class="btn btn-secondary me-2">Batal</a>
