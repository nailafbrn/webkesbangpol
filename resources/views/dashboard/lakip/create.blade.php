...
@section('title', 'Tambah Laporan AKIP')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('lakip.store') }}" method="POST" enctype="multipart/form-data">   
                            @csrf
                            <div class="mb-3">
                                <label for="title-lakip" class="form-label">Title</label>
                                <input type="text" class="form-control" id="title-lakip" name="title" required autocomplete="off">
                            </div>
